const uniqueEmail = 'Email должен быть уникальным.';
const emailValidation = 'Поле \'email\' не соответствует требуемому формату почты.';
const urlValidation = 'Поле не соответствует требуемому формату URL.';
